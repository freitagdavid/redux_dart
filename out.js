...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      return A.LinkedHashSet_LinkedHashSet$_literal([A.redux_dart__createStore$closure()], type$.dynamic_Function_dynamic_dynamic_dynamic);
    },
  ...
  (function installTearOffs() {
    ...
    _static(A, "redux_dart__createStore$closure", 3, null, ["call$3"], ["createStore"], 0, 0);
  })();
  (function inheritance() {
    var _inherit = hunkHelpers.inherit,
      _inheritMany = hunkHelpers.inheritMany;
    _inherit(A.Object, null);
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Rti, A._FunctionParameters, A._Type, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.Null, A.StringBuffer]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      dynamic_Function_dynamic_dynamic_dynamic: findType("@(@,@,@)"),
      int: findType("int"),
